<script lang="ts">
  ...
  import { Play, Pause, Users, Disc, ArrowLeft, Music, AlertCircle, RefreshCw, Heart, Plus, MoreVertical } from '@lucide/svelte';
              ...
              <table class="library-table" style="font-size: 0.95rem;">
                <thead>
                  <tr>
                    ...
                    <th style="width: 80px; text-align: center;" class="hide-mobile">Format</th>
